...
def populate_db():
    ...
    delivery_point1=DeliveryPoint.objects.create(
        ...
        city="Sofia",
        description="Fantastico main warehouse. Loading dock available. Open 8 AM – 6 PM"
    )
    delivery_point2=DeliveryPoint.objects.create(
        name='Econt',
        address="Nezavisimost 42",
        city="Plovdiv",
        description="Distribution hub. Requires appointment."
    )
    delivery_point3=DeliveryPoint.objects.create(
        name='Billa',
        address="Hristo Botev 21",
        city="Varna",
        description="Billa main warehouse. Temperature-sensitive items only."
    )
    ...
    delivery_point8=DeliveryPoint.objects.create(
        ...
        city="Shumen",
        description="Only small shipments accepted. Forklift available."
    )
    ...
    delivery_point10=DeliveryPoint.objects.create(
        ...
        city="Sofia",
        description="Kaufland main warehouse."
    )
    ...
    assignment=Assignment.objects.create(
        ...
        driver=driver1,
        vehicle=vehicle1,
        assignment_start=datetime(2026, 5, 1),
    ...
    assignment=Assignment.objects.create(
        ...
        driver=driver1,
        vehicle=vehicle2,
        assignment_start=datetime(2026, 5, 2),
        notes="Fragile Stock"
    )
    assignment3=Assignment.objects.create(
        ...
        driver=driver10,
        vehicle=vehicle8,
        assignment_start=datetime(2026, 5, 3),
    ...
    assignment5=Assignment.objects.create(
        ...
        driver=driver9,
        vehicle=vehicle2,
        assignment_start=datetime(2026, 5, 5),
        notes="Fresh Produce"
    )
    assignment6=Assignment.objects.create(
        ...
        driver=driver1,
        vehicle=vehicle6,
        assignment_start=datetime(2026, 5, 6),
    ...
    assignment9=Assignment.objects.create(
        ...
        driver=driver4,
        vehicle=vehicle4,
        assignment_start=datetime(2026, 5, 9),
    ...
    assignment10=Assignment.objects.create(
        ...
        driver=driver10,
        vehicle=vehicle10,
        assignment_start=datetime(2026, 5, 10),
